function [image_obj, networknames, imagenames] = load_bmrk5pain(varargin)
    ...
    % some bug fixes in the file
    if ~iscell(image_obj.additional_info.references)
        image_obj.additional_info.references = {image_obj.additional_info.references};
    end
